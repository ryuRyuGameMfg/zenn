---
title: "AIがゲームアニメーション制作を48倍速にする6つのツールと実践パイプライン"
emoji: "🎬"
type: "tech"
...
Uthana・Cascadeur・Rokoko Visionなど **6つのAIアニメーションツールを使い分けることで、従来2日かかっていたロコモーション制作が約1時間に短縮**できる。削減率は約90%、インディー開発者でも無料プランから即日導入可能だ。本記事ではツール比較から、Unity実装まで動くパイプラインを丸ごと解説する。
...
## 3. 実践: Unity × AI で作るアニメーションパイプライン
